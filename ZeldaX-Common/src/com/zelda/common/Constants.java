...
public class Constants {
    ...
    public static class MessageLength {
        ...
        public static final int POSITION_LENGTH = MessageType.LENGTH+OBJ_STR_TYPE_LENGTH+OBJ_INT_IDENTIFIER_LENGTH+POSITION_X+POSITION_Y;
        public static final int HERO_IDEN_LENGTH = MessageType.LENGTH+MessageLength.OBJ_STR_TYPE_LENGTH+MessageLength.OBJ_INT_IDENTIFIER_LENGTH;
        public static final int OBJ_REMOVAL_LENGTH = MessageType.LENGTH+MessageLength.OBJ_STR_TYPE_LENGTH+MessageLength.OBJ_INT_IDENTIFIER_LENGTH;
    }
